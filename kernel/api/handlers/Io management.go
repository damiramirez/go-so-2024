...
func NewIO(w http.ResponseWriter, r *http.Request){
	...
	global.IoMap[Device.Port]=global.NewDevice{Name: Device.Name,Port: Device.Port,Usage: Device.Usage,Type: Device.Type}
	global.Logger.Log(fmt.Sprintf("se conecto un nuevo  i/o a kernel %s ",global.IoMap[Device.Port].Name), log.DEBUG)
