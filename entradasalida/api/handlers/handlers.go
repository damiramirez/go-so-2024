...
func Stdout_write(w http.ResponseWriter, r *http.Request) {
	...
	valor, err := requests.PutHTTPwithBody[estructura_write, Valor_a_mandar](global.IOConfig.IPMemory, global.IOConfig.PortMemory, "stdout_write", estructura_actualizada)
	if err != nil {
	...
	global.Logger.Log(fmt.Sprintf("Memoria devolvió este valor: %+v", valor), log.INFO)
